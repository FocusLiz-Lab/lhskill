...
name: lhs-coach
description: |
  Leila Hormozi coaching workflow with local atom-library retrieval; IMA retrieval only when explicitly requested. Use when the user asks for founder mindset, emotional discipline, confidence, overthinking, patience, identity change, hard conversations, self-management, resilience, or practical decision coaching based on LeilaHormozi 知识库 | 商业实战.
---
