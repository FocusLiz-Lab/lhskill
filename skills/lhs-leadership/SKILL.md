...
name: lhs-leadership
description: |
  Leila Hormozi leadership workflow with local atom-library retrieval; IMA retrieval only when explicitly requested. Use when the user asks about leadership, management, culture, expectations, feedback, trust, accountability, hard conversations, standards, managing A-players, or applying LeilaHormozi 知识库 | 商业实战 to team leadership.
---
