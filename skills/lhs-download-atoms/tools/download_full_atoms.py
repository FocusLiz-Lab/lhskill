#!/usr/bin/env python3
"""Download and install the full Leila Hormozi atom library from GitHub Releases."""
...
REPO = "FocusLiz-Lab/lhskill"
ASSET_NAME = "lhs-local.zip"
...
def normalize_member(name: str) -> str:
    ...
    return normalized.split("/", 1)[1] if normalized.startswith("lhs/") else normalized
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        print("解压安装 Leila Hormozi 专家原子库 ...")
    ...
    print("商业案例库已抽离到 $commercial-case-library，不在 lhskill 内重复下载。")
    return 0
